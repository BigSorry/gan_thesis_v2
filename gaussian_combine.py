...
def doBoxplots(dataframe, score_names, save_path_map):
    for score_name in score_names:
        exp_vis.saveLambaBoxplotCombine(dataframe,  score_name, save_path_map)

def prepData():
    save_path_distributions = "./gaussian_combine/data/distributions.pkl"
    save_path_distances = "./gaussian_combine/data/distance_matrices.pkl"
...
def runGaussian():
    ...
    print("reading done")
    k_vals = [i for i in range(1, 100, 2)]
    ...
    real_map_path = "./gaussian_combine/real_scaled/"
    fake_map_path = "./gaussian_combine/fake_scaled/"
    score_names = ["pr_nearest_distance", "dc_nearest_distance"]
    doBoxplots(real_scaled_dataframe, score_names, real_map_path)
    doBoxplots(fake_scaled_dataframe, score_names, fake_map_path)
